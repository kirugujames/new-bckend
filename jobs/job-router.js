...
const validateJobCreation = [
  ...
  body("job_title").notEmpty().withMessage("Username is required")
]
/**
 * @swagger
 * /api/jobs/add:
 ...
 */
router.post("/add", validateJobCreation, verifyToken, async (req, res) => {
 ...
 *         description: Internal server error
 */
router.patch("/update", validateJobCreation, async (req, res) => {
